          ...
          <div className='modal_review_bottom'>
            <form onSubmit={writeReviewHandler}>
              ...
              <div className='modal_review_bottom_num'>
                <label for="onetwo">1 ~ 2개</label><input type="radio" id='onetwo' value="onetwo" name='num'/>
                <label for="threefour">3 ~ 4개</label><input type="radio" id='threefour' value="threefour" name='num'/>
                <label for="fivesix">5 ~ 6개</label><input type="radio" id='ivesix' value="ivesix" name='num'/>
                <label for="seven">7개 이상</label><input type="radio" id='seven' value="seven" name='num'/>
              </div>
